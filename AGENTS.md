...
- **El zip SIEMPRE incluye la doc skill** en `comegenui/docs/comegen-ui/` (`SKILL.md` + `componentes/`) — viaja con la lib para que los agentes del proyecto consumidor tengan la doc. El zip descomprime en la carpeta `comegenui/` (sin `dist/`)
