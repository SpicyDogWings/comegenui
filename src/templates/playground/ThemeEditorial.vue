...
const docOutlineItems = [
  { label: 'Introducción', id: 'intro' },
  { label: '¿Cómo funciona?', id: 'how', children: [
    { label: 'Tokens de color', id: 'color-tokens' },
    { label: 'Tipografía', id: 'typography' },
  ]},
  { label: 'Buenas prácticas', id: 'practices' },
]
</script>
