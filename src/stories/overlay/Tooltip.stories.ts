  ...
  api: {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "number",
        "default": "6",
        "description": "Distancia del tooltip al trigger (px)"
      },
      {
        "name": "disabled",
        "type": "boolean",
        "default": "false",
        "description": "No muestra el tooltip"
      },
      {
        "name": "text",
        "type": "string",
      ...
      },
      {
        ...
        "type": "number",
        "default": "200",
        "description": "Delay en ms hasta mostrar el tooltip"
      }
    ],
    "slots": [
      {
      ...
      {
        "name": "content",
        "description": "Contenido custom del tooltip. Si no se usa, se muestra la prop text"
      }
    ]
  },
  sections: [
