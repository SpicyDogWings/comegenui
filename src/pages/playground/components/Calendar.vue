...
const componentDeps = [{ label: 'MonthSlider', path: '/playground/components/month-slider' }];
    ...
    <div class="playground-content">
      ...
      <section id="style" class="playground-section">
        ...
        <ul class="playground-component-links">
          <li><a href="/playground/components/month-slider" class="playground-component-link">MonthSlider</a> — revisá sus variables CSS en su propia sección Style</li>
        </ul>
      </section>
