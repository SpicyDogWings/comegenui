...
const componentDeps = [{ label: 'Button', path: '/playground/components/button' }, { label: 'Select', path: '/playground/components/select' }];
    ...
    <div class="playground-content">
      ...
      <section id="style" class="playground-section">
        ...
        <ul class="playground-component-links">
          ...
          <li><a href="/playground/components/select" class="playground-component-link">Select</a> — revisá sus variables CSS en su propia sección Style</li>
        </ul>
      </section>
      ...
      <section id="api" class="playground-section">
        ...
        <ul class="playground-component-links">
          <li v-for="dep in [{ label: 'Button', path: '/playground/components/button' }, { label: 'Select', path: '/playground/components/select' }]" :key="dep.label">
