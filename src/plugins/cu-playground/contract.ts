 ...
 * capas (L1 `.vue`, L2 `.ce`, L3 `.umd`).
 *
 * `src/stories/types.ts` re-exporta estos tipos (backwards compat). El plugin
 * es el dueño del contrato para poder copiarse a otro proyecto sin depender de
 * archivos del host.
 */
